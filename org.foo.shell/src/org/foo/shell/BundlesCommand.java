...
public class BundlesCommand extends BasicCommand
{
	...
	public void exec(String args, PrintStream out, PrintStream err) throws Exception
	{
		...
		{
			printBundle( bundle.getBundleId(), getStateString( bundle.getState() ), bundle.getHeaders().get( Constants.BUNDLE_NAME ), bundle.getLocation(), bundle.getSymbolicName(), out );
		}
	}
