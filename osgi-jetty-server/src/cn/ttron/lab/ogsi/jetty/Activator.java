...
public class Activator implements BundleActivator
{
	...
	public void start(BundleContext context) throws Exception
	{
		...
		serverProps.put( "jetty.etc.config.urls", "file:M:/W/amdatu-do/osgi-jetty-server/conf/jetty.xml,file:M:/W/amdatu-do/osgi-jetty-server/conf/jetty-deployer.xml" );
